...
gr.Interface.load(inference = InferenceApi(repo_id="hamdan07/UltraSound-Lung", token="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"),examples=example_list,title=title,description=description).launch(debug=False,share=False)
